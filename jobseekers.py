...
jobseeker_parser.add_argument('middle_name', type=str)
...
jobseeker_parser.add_argument('phone_number', type=int, required=True, help='phone_number is required')
...
api_bp.add_resource(JobSeekers, '/<int:id>')
...
class JobSeekersList(Resource):
    ...
    def post(self):
        ...
        db.session.commit()
        return {'message': 'Job Seeker successfully created'}
