...
details_parser.add_argument('jobseeker_id', type=str, required=False, help='Portfolio URL is required')
...
class JobSeekersDetailsResource(Resource):
    def post(self, jobseeker_id):
        ...
        details = JobSeekersDetails(resume_url=data['resume_url'], skills=data['skills'], education_level=data['education_level'], work_experience=data['work_experience'], portfolio_url=data['portfolio_url'], jobseeker_id=data[jobseeker_id])
